  ...
  static Future<Map<String, dynamic>> registerDevice(String deviceName) async {
    try {
      ...
      final response = await http.post(
        ...
        onTimeout: () {
          print('❌ [DeviceService] Timeout al registrar dispositivo');
  ...
  static Future<Map<String, dynamic>> checkDeviceStatus() async {
    ...
    try {
      ...
      final response = await http.get(
        Uri.parse('${APIService.baseUrl}/api/auth/device-status/$deviceId'),
        headers: {
  ...
  static Future<Map<String, dynamic>> downloadCertificate() async {
    ...
    try {
      ...
      final response = await http.get(
        ...
        onTimeout: () {
          print('❌ [DeviceService] Timeout al descargar certificado');
          throw Exception('Timeout: No se pudo descargar el certificado');
        },
      );
